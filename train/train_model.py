...
pos_seq_train = np.load('/.../PlantTISTool/PlantTIS/train/train_p_set.npy',  allow_pickle=True)

for i in range(1, 11):
    neg_seq_train = np.load("neg_train_" + str(i) + ".npy",  allow_pickle=True)

    pos_seq_valid = np.load('/.../PlantTISTool/PlantTIS/train/val_p_set.npy',  allow_pickle=True)
    neg_seq_valid = np.load('/.../PlantTISTool/PlantTIS/train/val_n_set_same.npy',  allow_pickle=True)
    ...
    modelDic = "/.../PlantTISTool/PlantTIS/train/model/"
    history = LossHistory()

    filepath = str(i) + '_model.hdf5'
